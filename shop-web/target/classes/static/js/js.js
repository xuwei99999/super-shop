...
$(function(){
	...
	$.ajax({
		...
		success:function (data) {
			...
			$("#floor1 .floorRight .frProList").empty();
			$("#floor1 .floorRight .frProList").append(content)
		}
	})
	...
	$.ajax({
		...
		success:function (data) {
			...
			$("#floor2 .floorRight .frProList").empty();
			$("#floor2 .floorRight .frProList").append(content)
		}
	})
	$.ajax({
		url:"queryGoodsByGtype",
		...
		success:function (data) {
			...
			$("#floor3 .floorRight .frProList").empty();
			$("#floor3 .floorRight .frProList").append(content)
		}
	})
	//rdList
